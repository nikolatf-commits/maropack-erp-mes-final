...
export default function NalogFormatiranje_Spulna({ nalog }) {
  const { 
    ponBr = 'MP-2026-XXXX', 
    kupac = '', 
    prod = '', 
  ...
  // Boja na osnovu tipa
  const headerColor = 'NalogFormatiranje_Spulna' === 'NalogCrtez_Kesa' || 'NalogFormatiranje_Spulna' === 'NalogKesa_Kesa' || 'NalogFormatiranje_Spulna' === 'NalogPotrebaMaterijala_Kesa'
    ? 'linear-gradient(135deg, #059669, #10b981)'
    : 'linear-gradient(135deg, #b91c1c, #ef4444)';
    
  const naziv = 'NalogFormatiranje_Spulna'.replace(/_/g, ' - ');
