...
export default function NalogPotrebaMaterijala_Kesa({ nalog }) {
  const { 
    ponBr = 'MP-2026-XXXX', 
    kupac = '', 
    prod = '', 
  ...
  // Boja na osnovu tipa
  const headerColor = 'NalogPotrebaMaterijala_Kesa' === 'NalogCrtez_Kesa' || 'NalogPotrebaMaterijala_Kesa' === 'NalogKesa_Kesa' || 'NalogPotrebaMaterijala_Kesa' === 'NalogPotrebaMaterijala_Kesa'
    ? 'linear-gradient(135deg, #059669, #10b981)'
    : 'linear-gradient(135deg, #b91c1c, #ef4444)';
    
  const naziv = 'NalogPotrebaMaterijala_Kesa'.replace(/_/g, ' - ');
