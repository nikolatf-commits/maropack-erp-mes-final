...
export default function DashboardPRO({ setPage }) {
  ...
  useEffect(() => {
    ...
    const sub = supabase
      ...
      .on("postgres_changes", { event: "*", schema: "public", table: "nalozi" }, loadAllData)
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.syncInfo}>Isti izvor: <b>nalozi, magacin, nalog_aktivnosti</b> · Period: <b>{timeRange} dana</b></div>
      ...
      <div style={styles.kpiGrid}>
        ...
        <KPICard icon="📦" label="Rolne u magacinu" value={kpi.ukupnoRolni} subtitle={`${kpi.rolneNaStanju} na stanju`} color="#8b5cf6" />
        <KPICard icon="📏" label="Ukupno metara" value={formatNumber(kpi.ukupnoMetara, "m")} color={COLORS.pink} />
        <KPICard icon="💰" label="Ukupna vrednost" value={formatNumber(kpi.ukupnaVrednost, "€")} color="#0ea5e9" />
