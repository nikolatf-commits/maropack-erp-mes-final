                                            ...
                                            return (
                                                <React.Fragment key={s.o.id + i}>
                                                    ...
                                                    <div draggable={!!dragStart} onDragStart={(e) => dragStart && dragStart(e, s.o.id)}
                                                        ...
                                                        style={{ position: "absolute", left: x1, width: Math.max(58, x2 - x1 - 3), top: 13, height: 44, borderRadius: 10, background: boja, color: "#fff", fontSize: 11.5, fontWeight: 900, padding: "5px 9px", overflow: "hidden", whiteSpace: "nowrap", textOverflow: "ellipsis", boxSizing: "border-box", cursor: "grab", boxShadow: "0 3px 8px rgba(15,23,42,.18)", opacity: s.o.status === "u_radu" ? 1 : .93, outline: s.probija ? "2px solid #dc2626" : "none", zIndex: 1 }}>
                                                        <div style={{ overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{s.eksterno ? "📦 " : ""}{s.o.opIkona ? s.o.opIkona + " " : ""}{s.o.id}</div>
                                                        <div style={{ fontWeight: 700, fontSize: 10, opacity: .92, marginTop: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{s.eksterno ? "u štampariji · povratak " + fmtD(s.end) : "gotov: " + fmtT(s.end)}{s.probija ? " ⚠+" + s.kasniDana + "d" : ""}{s.uskok ? " ↷" : ""}{s.vanPlana ? " · preth. nije u planu!" : ""}</div>
                                                    </div>
