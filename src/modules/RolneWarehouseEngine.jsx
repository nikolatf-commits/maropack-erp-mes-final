            ...
            <div style={{ overflowX: "auto" }}><table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
                ...
                <tbody>{packingRows.map((r, i) => {
                    ...
                    return <tr key={i}>
                        ...
                        <td style={cell}><input style={{ ...compactInput, minWidth: 130 }} list="row-proizvodjaci" value={r.proizvodjac || ""} onChange={(e) => updateRow(i, { proizvodjac: e.target.value })} placeholder="Lista ili novi" /><datalist id="row-proizvodjaci">{[...new Set([...(masterProizvodjaci || []), ...(opts.proizvodjaci || [])])].filter(Boolean).map((v) => <option key={v} value={v} />)}</datalist></td>
