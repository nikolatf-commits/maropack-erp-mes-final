...
function kesaD(nalog) {
    ...
    const k = kesa || {};
    const W = num(k.sirina), H = num(k.duzina);
    // Klapna/falta — hvataj i alternativne nazive iz templejta (klapnaMm, flap, iz t.kesa…),
    // da povuče vrednost i kad nije upisana baš pod "klapna"/"falta".
    const tk = (t && t.kesa) || {};
